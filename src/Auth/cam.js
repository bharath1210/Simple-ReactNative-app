...
import FileSystem from 'expo-fileSystem'
...
const {   Permissions, BarCodeScanner,FaceDetector } = Expo
console.log(Expo)
...
export default class CameraScreen extends React.Component {
  ...
  onFacesDetected = ({ faces }) =>{console.log(';;;;**********************;;;;;', {faces});  this.setState({ faces })};
      ...
      <View style={styles.options}>
        <View style={styles.detectors}>
          <TouchableOpacity onPress={this.toggleFaceDetection}>
            <MaterialIcons name="tag-faces" size={22} color={this.state.faceDetecting ? "white" : "#858585" } />
          </TouchableOpacity>
